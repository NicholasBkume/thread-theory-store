...
const CreateProductForm = () => {
	...
	return (
		<motion.div
			className='bg-stone-800 shadow-lg rounded-lg p-8 mb-8 max-w-xl mx-auto'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ duration: 0.8 }}
		>
			<h2 className='text-2xl font-semibold mb-6 text-yellow-300'>Create New Product</h2>
			...
			<form onSubmit={handleSubmit} className='space-y-4'>
				...
				<div className='mt-1 flex items-center'>
					...
					{newProduct.image && <span className='ml-3 text-sm text-stone-400'>Image uploaded </span>}
				</div>

            ...
            <div className='space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0'>
                ...
                <div className='flex items-center justify-between md:order-3 md:justify-end'>
                    <div className='flex items-center gap-2'>
                        <button
                            className='inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border
                             border-stone-600 bg-stone-700 hover:bg-stone-600 focus:outline-none focus:ring-2
                        ...
                        <button
                            className='inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border
                             border-stone-600 bg-stone-700 hover:bg-stone-600 focus:outline-none 
                    ...
                    <div className='text-end md:order-4 md:w-32'>
                        <p className='text-base font-bold text-yellow-400'>${item.price}</p>
                    </div>
                </div>

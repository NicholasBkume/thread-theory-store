		...
		<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
			<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
				...
				<AnalyticsCard
					...
					icon={DollarSign}
					color='from-yellow-500 to-lime-700'
				/>
			</div>
			<motion.div
				className='bg-stone-800/60 rounded-lg p-6 shadow-lg'
...
const AnalyticsCard = ({ title, value, icon: Icon, color }) => (
	<motion.div
		className={`bg-stone-800 rounded-lg p-6 shadow-lg overflow-hidden relative ${color}`}
		initial={{ opacity: 0, y: 20 }}
		animate={{ opacity: 1, y: 0 }}
	...
	>
		<div className='flex justify-between items-center'>
			<div className='z-10'>
				<p className='text-yellow-300 text-sm mb-1 font-semibold'>{title}</p>

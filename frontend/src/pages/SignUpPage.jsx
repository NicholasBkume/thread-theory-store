...
const SignUpPage = () => {
	...
	return (
		<div className='flex flex-col justify-center py-12 sm:px-6 lg:px-8'>
			...
			>
				<h2 className='mt-6 text-center text-3xl font-extrabold text-yellow-400'>Create your account</h2>
			</motion.div>
			...
			>
				<div className='bg-stone-800 py-8 px-4 shadow sm:rounded-lg sm:px-10'>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className='block w-full px-3 py-2 pl-10 bg-stone-700 border border-stone-600 rounded-md shadow-sm
									 placeholder-stone-400 focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm'
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									rounded-md shadow-sm
									 placeholder-stone-400 focus:outline-none focus:ring-yellow-500 
						...
						<div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-stone-700 border border-stone-600 
									rounded-md shadow-sm placeholder-stone-400 focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
							...
							<div className='mt-1 relative rounded-md shadow-sm'>
								...
								<input
									...
									className=' block w-full px-3 py-2 pl-10 bg-stone-700 border
									 border-stone-600 rounded-md shadow-sm placeholder-stone-400 focus:outline-none focus:ring-yellow-500 focus:border-yellow-500 sm:text-sm'
									placeholder='••••••••'
								/>
							</div>
						</div>
